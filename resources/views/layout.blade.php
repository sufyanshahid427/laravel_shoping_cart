...
<html>
<head>
    <title>Laravel Shopping Cart add to cart</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<div class="navbar-nav ml-auto action-buttons">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-primary  " data-toggle="dropdown" style= "margin-right:125px; margin-left:35px;">
                ...
                <div class="dropdown-menu mt-4 bg-light rounded">
                        ...
                        @foreach(session('cart') as $id => $details)
                            <div class="row cart-detail" >
                                <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                    <img src="{{ asset('img') }}/{{ $details['photo'] }}" width="85px" height="85px" class="img-responsive" />
                                </div>
                                <div class="col-lg-8 col-sm-8 col-8 cart-detail-product"  style="margin-bottom:30px;">
                                    <b><span>{{ $details['product_name'] }}</span></b><br>
                                    <span class="price text-danger " > ${{ $details['price'] }}</span><br> 
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                            <a href="{{ route('cart') }}" class="btn btn-primary rounded-pill">View all</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- <div class="container">
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-12">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-primary mt-2" data-toggle="dropdown" style="margin-left:90%;">
                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart <span class="badge badge-pill badge-danger">{{ count((array) session('cart')) }}</span>
                </button>
...
<br/>
<div class="container" width="40px">
